...
<html lang="en">
   ...
   <body class="clinic_version">
      ...
      <div style="width:50%; position: absolute; margin-top: 8%; margin-left: 10%; display: block">
          ...
          <h2>Stemming for Data &emsp;&emsp; Term Frequency for Data</h2>
            <textarea rows="10" cols="30" style='color:black'><%=ste%></textarea>
            &emsp;&emsp;&emsp;<textarea rows="10" cols="30" style='color:black' ><%=tf%></textarea>
          </div>
