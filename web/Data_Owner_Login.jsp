   ...
   <body class="clinic_version">
      ...
      <header>
         ...
         <div class="header-bottom wow fadeIn" style="background-color: black">
            <div class="container">
             ...
             <li><a data-scroll href="Data_Owner_Login.jsp">Doctors</a></li>
                        ...
                        <li><a data-scroll href="Token_Login.jsp">Admin</a></li>
    	...
    	h4{
    		...
    		<center>
    			<h2><strong>Data Owner Login</strong></h2><br>
    			<form action="Data_Owner_Login">
    			<table>
    			...
    			<h4><a href="Data_Owner_Register.jsp">If New User?Register</a></h4>
    		</center>
    	</div>
      <!-- end copyrights -->
