   ...
   <body class="clinic_version">
      ...
      <header>
          ...
          <div class="header-bottom wow fadeIn" style="background-color: black">
			...
			<li><a class="active" data-scroll href="Cloud_Login.jsp">Cloud Server</a></li>
                     </ul>
                  </div>
               </nav>
            </div>
    	...
    	input{
    		...
    		<img src="images/cloudback.jpg" alt="" style="height:300px;width:1280px; margin-top:60px;">
    		<center>
    			<h2><strong>Cloud Login</strong></h2><br>
