    		...
    		<center>
    			...
    			<table>
                            ...
                            <%
                                ...
                                PreparedStatement ps=con.prepareStatement("select * from file_req where uname='"+uname+"' ");
                            ...
                            <tr>
                                ...
                                <td><a href="Download.jsp?fname=<%=r.getString("filename")%>" style='color:darkgreen;font-weight: bold;'>Download</a></td>    
