...
<html lang="en">
   ...
   <body class="clinic_version">
                  ...
                  <div class="navbar-header">
                   ...
                   <%
                       ...
                       String pic=(String)session.getAttribute("pic");
                        String tkey=(String)session.getAttribute("tkey");
                        String oid=(String)session.getAttribute("owner_id");
      ...
      <div style="width:50%; position: absolute; margin-top: 8%; margin-left: 10%; display: block">
          <h2 style="margin-left: 10%;">Upload Patient Record</h2>
          <style>
              table,td,th,tr{
          ...
          <table style="margin-top:10px;">
              ...
              <tr><td><strong>Patient ID</strong></td><td><input type="text" name="pid" required></td></tr>
              <tr><td><strong>Patient Name</strong></td><td><input type="text" name="pname" required></td></tr>
               <tr><td><strong>Disease</strong></td><td><input type="text" name="dis" required></td></tr>
              <tr><td><strong>Age</strong></td><td><input type="text" name="page" required></td></tr>
              <tr><td><strong>Mobile</strong></td><td><input type="text" name="mobile" required></td></tr>
              <tr><td><strong>Email</strong></td><td><input type="email" name="mail" required></td></tr>
              <tr><td><strong>Date & Time</strong></td><td><input type="text" name="date" value='<%=d%>' required></td></tr>
              <tr><td><strong>Trapdoor Key</strong></td><td><input type="text" name="tkey" value="<%=tkey%>" required></td></tr>
              <tr><td><strong>Upload Record</strong></td><td><input type="file" name="file" required></td></tr>
              <tr><td align="center" colspan="2"><input type="submit" name="Uplaod" required></td></tr>
          </table></form>
          </div>
