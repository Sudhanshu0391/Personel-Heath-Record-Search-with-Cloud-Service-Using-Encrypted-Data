...
<html lang="en">
   ...
   <body class="clinic_version">
      ...
      <div style="width:50%; position: absolute; margin-top: 8%; margin-left: 10%; display: block">
          <h2 style="margin-left: 20%;">Search Results</h2>
          <style>
              table,td,th,tr{
          ...
          <%
            ...
            PreparedStatement p=con.prepareStatement("select * from file where fname='"+key+"' group by fname");
          ...
          <table style="margin-top:10px;">
              ...
              <tr><td><strong><%=fname%></strong></td></tr>
              <tr><td><a href="Send_Key_Request.jsp?uid=<%=uid%>&&uname=<%=uname%>&&fn=<%=fname%>&&mail=<%=email%>&&key=<%=key%>">Send Request</a></td></tr>
          </table><%}%>
          </div>
