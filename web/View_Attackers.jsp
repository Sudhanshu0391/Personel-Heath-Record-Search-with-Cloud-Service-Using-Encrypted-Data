   ...
   <body class="clinic_version">
            ...
            <div class="container">
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                        ...
                        <li><a  data-scroll href="Send_File_Key.jsp">Send File Key</a></li>
                         <li><a  class="active" data-scroll href="View_Attackers.jsp">View Attackers</a></li>
      ...
      <div  style="height:900px; margin-top:60px; background: #bce8f1;">
    	...
    	h4{
    		...
    		<center>
                    <br><h2><strong>View All Attackers</strong></h2><br>
    			<table>
                            <tr>
                                <th>ID</th>
                                <th>User Name</th>
                            ...
                            <%
                                ...
                                PreparedStatement ps=con.prepareStatement("select * from attacker ");
