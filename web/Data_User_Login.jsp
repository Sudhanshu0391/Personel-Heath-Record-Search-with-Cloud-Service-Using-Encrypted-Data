   ...
   <body class="clinic_version">
      ...
      <header>
    	...
    	h4{
    		...
    		<img src="images/datauser.png" alt="" style="height:300px;width:1280px; margin-top:60px;">
    		<center>
    			<h2><strong>Data User Login</strong></h2><br>
    			<form action="Data_User_Login">
    			<table>
    				...
    				<tr><td align="center" colspan="2"><input type="submit" name="Login" style="color:indigo;"></td></tr>
    			</table></form>
    			<h4><a href="Data_User_Register.jsp">If New User?Register</a></h4>
    		</center>
    	</div>
      <!-- end copyrights -->
