   ...
   <body class="clinic_version">
      ...
      <div  style="height:900px; margin-top:60px; background: #bce8f1;">
    	...
    	h4{
    		...
    		<center>
                    <br><h2><strong>View & Authorize Users</strong></h2><br>
    			<table>
                            <tr>
                                <th>User ID</th>
                                <th>User Name</th>
                            ...
                            <tr>
                                ...
                                <%}
                                 ...
                                 %> 
                                <td><a href="Authorize_ActionUser.jsp?id=<%=r.getString("user_id")%>&&oname=<%=r.getString("username")%>" style='color:darkgreen;font-weight: bold;'>Authorize</a></td>    
                                <%}%>
                            </tr>
                            <%}%>
    			</table>
